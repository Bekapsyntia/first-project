...
function arcsin() {display.value = Math.arcsin(eval(display.value) * 180 / Math.PI);}
function arccos() {display.value = Math.arccos(eval(display.value) * 180 / Math.PI);}
function arctan() {display.value = Math.arctan(eval(display.value) * 180 / Math.PI);}
